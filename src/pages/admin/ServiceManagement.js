    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (modalEntity === 'service') {
                ...
                submitData.min_delivery_days = parseInt(submitData.min_delivery_days) || 0;
                submitData.max_delivery_days = parseInt(submitData.max_delivery_days) || 0;
    ...
    return (
        <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Min Working Days</label>
                    <input
                        type="number"
                        min="0"
                        value={formData.min_delivery_days ?? ''}
                        onChange={(e) => handleChange('min_delivery_days', e.target.value)}
                        readOnly={isReadOnly}
                        className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                        required
                    />
                ...
                <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Max Working Days</label>
                    <input
                        type="number"
                        min="0"
                        value={formData.max_delivery_days ?? ''}
                        onChange={(e) => handleChange('max_delivery_days', e.target.value)}
                        readOnly={isReadOnly}
                        className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                        required
                    />
