            ...
            <div className="w-full max-w-md space-y-8 bg-white p-6 sm:p-8 rounded-lg shadow-md">
                <div className="space-y-4">
                    ...
                    <p className="text-center text-gray-600">
                        Please enter the verification code sent to <span className="font-medium break-all">{verificationEmail}</span>
                    </p>
                </div>
                    ...
                    <div className="flex justify-center gap-2 sm:gap-3">
                        {otp.map((digit, index) => (
                            <input
                                ...
                                className="w-10 h-12 sm:w-12 sm:h-14 text-center text-xl font-semibold border rounded-md shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500 focus:outline-none transition-colors duration-200"
                            />
                        ))}
                    </div>
