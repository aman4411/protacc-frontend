...
const AdminLayout = ({ children }) => {
    ...
    const menuItems = [
        ...
        { name: 'Deadline Management', path: '/admin/deadlines', icon: FaCalendarAlt },
        { name: 'Articles', path: '/admin/articles', icon: FaPenNib },
    ...
    return (
        <div className="flex h-screen bg-gray-100">
            {/* Sidebar */}
            <div className={`bg-indigo-800 text-white w-64 space-y-6 py-7 px-2 absolute inset-y-0 left-0 transform overflow-y-auto ${
